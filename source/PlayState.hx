...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Youre Shit at this and your mama will not love you!!', 0.2], //From 0% to 19%
		['NO PLS', 0.4], //From 20% to 39%
		['FUCK ', 0.5], //From 40% to 49%
		['Bro Just Hit The Notes In The Right Time', 0.6], //From 50% to 59%
		['Not Good ', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['Almost There', 0.8], //From 70% to 79%
		['Bravo!', 0.9], //From 80% to 89%
		['Very Awesome!', 1], //From 90% to 99%
		['NANA JOTE WILL LOVE YOU!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
